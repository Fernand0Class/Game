...
export class PreloadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        // Spritesheets de animaciones - Personaje 3
        this.load.image('personaje3', 'Personajes/Personaje 3.png');
        this.load.spritesheet('personaje3_walk', 'Sprites/Caminar persoanje 3.png', {
            frameWidth: 64,
            frameHeight: 64
        });
